...
<head>
    ...
    <!-- Product Sans used by the header component -->
    <link href="//fonts.googleapis.com/css?family=Product+Sans:400&amp;lang=en" rel="stylesheet">
    <link href="/css/csfirst.min.css" rel="stylesheet">
    <link href="/css/maia.min.css" rel="stylesheet">
    <!-- Local assets -->
<!--         <link rel="stylesheet" href="/css/maia.min.css">
-->        <script src="/js/angular.min.js"></script>
<!--         <script src="/js/maia.min.js"></script>
-->        <!-- Hercules CDN -->
    ...
    <div class="h-c-header__lockup">
        <div class="h-c-header__company-logo">
            <div class="h-c-header__company-logo-link" title="Google">
                <img src="/img/硅谷侠4.png" width="150px">
            </div>
        </div>
        <div class="h-c-header__product-logo">
            <div class="h-c-header__product-logo-link">
...
<div class="h-c-header__initiative-logo">
    <a href="https://edu.google.com" class="h-c-header__initiative-logo-link">
      <span class="h-c-header__initiative-logo-text">
          For Education
      </span>
  </a>
</div>
...
<nav class="h-c-header__nav">
    <ul class="h-c-header__nav-list">
        <li class="h-c-header__nav-li" aria-level="1">
            <a href="/" class="h-c-header__nav-li-link h-is-active h-is-highlighted">
                CS First
            </a>
        </li>
        <li class="h-c-header__nav-li" aria-level="1">
            <a href="/materials" class="h-c-header__nav-li-link">
                Curriculum
            </a>
        </li>
        <li class="h-c-header__nav-li" aria-level="1">
...
<div class="h-c-header__cta">
    <ul class="h-c-header__cta-list">
        <li class="h-c-header__cta-li h-c-header__cta-li--primary sign-in">
            <a href="/signin-front" class="h-c-header__cta-li-link h-c-header__cta-li-link--primary">
                Sign in
            </a>
        </li>
        <li class="h-c-header__cta-li h-c-header__cta-li--secondary sign-out">
            <a href="/user/logout" class="h-c-header__cta-li-link h-c-header__cta-li-link--secondary">
                Sign Out
            </a>
        </li>
    </ul>
    ...
    <div class="h-c-header__drawer-bar">
        ...
        <div class="h-c-header__drawer-product-logo">
            <div class="h-c-header__drawer-product-logo-link">
                <span class="h-c-header__drawer-product-logo-text">For Education</span>
            </div>
        </div>
    </div>
...
<nav class="h-c-header__drawer-nav">
    <ul class="h-c-header__drawer-nav-list">
        <li class="h-c-header__drawer-nav-li" aria-level="1">
            <a href="/" id="h-js-header__drawer-focus-item"
            class="h-c-header__drawer-nav-li-link h-is-active">
            CS First
        </a>
    </li>
    <li class="h-c-header__drawer-nav-li" aria-level="1">
        <a href="/materials" id="h-js-header__drawer-focus-item"
        class="h-c-header__drawer-nav-li-link">
        Curriculum
    </a>
</li>
<li class="h-c-header__drawer-nav-li" aria-level="1">
    <a href="//support.google.com/csfirst" target="_blank" id="h-js-header__drawer-focus-item"
    class="h-c-header__drawer-nav-li-link">
    Help
</a>
</li>
...
<footer class="h-c-footer h-c-footer--standard h-has-social">
            ...
            <div class="h-c-social__group">
                ...
                <ul class="h-c-social__list h-no-bullet">
                    <li class="h-c-social__item">
                        <!-- TODO (adodson) set up classroom sharing -->
                        <a href="#shareon-classroom" aria-label="Share on Classroom">
                            <img src="https://csfirst.withgoogle.com/images/logo_classroom_48dp.png" alt="Google Classroom icon" class="h-c-icon h-c-icon--social h-c-icon--no-padding h-c-icon--24px">
                        </a>
                    </li>
                    <li class="h-c-social__item">
    ...
    <section class="h-c-footer__global">
        <div class="h-c-footer__logo">
            <a href="https://www.avantcoding.com" aria-label="Google" target="_blank">
                <img src="/img/硅谷侠4.png" width="150px">
            </a>
        </div>
        <div class="row">
            <div class="col text-center" style="font-size: 14px;">
                ...
                <a href="http://www.miitbeian.gov.cn/">
                    备案号: 粤ICP备16013188号-3
                </a>
            </div>
        </div>
        <ul class="h-c-footer__global-links h-c-footer__global-links--extra h-no-bullet">
            <li class="h-c-footer__global-links-list-item h-c-footer__global-links-list-item--extra">
                <a class="h-c-footer__link" href="http://support.google.com/csfirst">
...
<script type="text/javascript">
    document.addEventListener('DOMContentLoaded', function() {
        var picker = document.getElementById('lang-selector');
        if (picker) {
            picker.onchange = function() {
                var lang = picker.options[picker.selectedIndex].value;
                document.cookie = 'Drupal.visitor.lang=' + lang + ';path=/';
                window.location = '/' + lang + '/home'
            };
        }

        var request = new XMLHttpRequest();
        request.open('GET', '/d/role', true);
        request.onreadystatechange = function() {
            if (request.readyState === XMLHttpRequest.DONE && request.status === 200) {
                var role = JSON.parse(request.responseText.substr(5))['role'];
                var elements = document.querySelectorAll(role === 'anonymous' ? '.sign-in' : '.sign-out');
                for (var i = 0; i < elements.length; i++) {
                    elements[i].className = elements[i].className.replace('sign-in', '').replace('sign-out', '');
                }
            };
        }
        request.send();
